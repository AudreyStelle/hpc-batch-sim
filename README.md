...
**Problem:**  
High-performance computing (HPC) environments often require running multiple batch jobs efficiently. However, users need a simple way to monitor system health and job progress without an overlycomplicated infrastructure setup. This project addresses that gap for developers, students, or researchers who want to simulate HPC-style batch processing on a local machine.
